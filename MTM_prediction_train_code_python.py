# -*- coding: utf-8 -*-
"""
Created on Tue May 24 06:07:26 2016
...
file_wd = 'C:\\Users\\Administrator\\Desktop\\\Input_FUT\\NN_model\\' + str(train_dt) + '\\python runs'
...
#    cols = [i for i in range(0,42)]
    file_train = 'C:\\Users\\Administrator\\Desktop\\Input_FUT\\NN_model\\' +str(train_dt) + '\\first_train_data.csv'
    file_val = 'C:\\Users\\Administrator\\Desktop\\Input_FUT\\NN_model\\' +str(train_dt) + '\\first_val_data.csv'
    train = genfromtxt(file_train, delimiter=',', skip_header=20)
#    train  = np.delete(train, np.s_[0:3], axis=1) 
#    train = np.delete(train, np.s_[39:55], axis=1)
    validation = genfromtxt(file_val, delimiter=',', skip_header=20)
